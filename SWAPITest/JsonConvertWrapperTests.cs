...
namespace SWAPITest
{
    ...
    public class JsonConvertWrapperTests
    {
        ...
        [TestMethod]
        public void GivenCorrectJson_WhenCallDeserializeObject_ShouldReturnDeserializedObject()
        {
            //arrange
            
            //act
            var result =_jsonConvertWrapper.Deserialize(json);
            //assert
        ...
        [TestMethod]
        public void GivenFalseJson_WhenCallDeserializeObject_ShouldNotThrowException()
        {
            //arrange
             var json2 = @"{""test"": 5}";
            ...
            try
            {
                var result = _jsonConvertWrapper.Deserialize(json2);
                if (result != null) message = string.Empty;
            }
            catch (Exception ex)
            {
                message = ex.Message;
            ...
            //assert
            message.Should().BeNullOrWhiteSpace();
        }
